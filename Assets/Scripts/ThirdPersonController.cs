...
public AnimationClip jumpPoseAnimation;
    */
    ...
    // Always orthogonal to the forward vector
     ...
     float v = _gamePad.LeftStick.Y;
     float h = _gamePad.LeftStick.X;
    ...
    if (grounded)
    {
        ...
        if (_gamePad.RB.Pressed || _gamePad.RB.Held)
        {
    ...
    if (isControllable) // don't move player at all if not controllable.
    {
        ...
        bool jumpButton = _gamePad.A.Pressed;
    ...
    bool IsMoving()
    {
        return Mathf.Abs(_gamePad.LeftStick.X) + Mathf.Abs(_gamePad.LeftStick.Y) > 0.5f;
    }
